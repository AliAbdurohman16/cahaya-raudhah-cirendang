                    ...
                    <div class="custom-field-wrap">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nama Paket">
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control @error('passenger') is-invalid @enderror" name="passenger" placeholder="Maksimal Penumpang">
                                    @error('passenger')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4">
                                <label>Tanggal</label>
                                <div class="form-group">
                                    <input type="date" class="form-control @error('date') is-invalid @enderror" name="date" placeholder="Tanggal">
                                    @error('date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4">
                                <label>Hari</label>
                                <div class="form-group">
                                    <input type="text" class="form-control @error('day') is-invalid @enderror" name="day" placeholder="Hari">
